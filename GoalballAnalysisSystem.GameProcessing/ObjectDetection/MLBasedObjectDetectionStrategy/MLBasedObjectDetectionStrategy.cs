...
using GoalballAnalysisSystem.GameProcessing.ObjectDetection.MLBasedObjectDetectionStrategy.Models;
using Microsoft.ML;
...
namespace GoalballAnalysisSystem.GameProcessing.ObjectDetection.MLBasedObjectDetectionStrategy
{
    public class MLBasedObjectDetectionStrategy : IObjectDetectionStrategy
    {
        ...
        public MLBasedObjectDetectionStrategy(List<string> targetLabels)
        {
            ...
            var pipeline = context.Transforms.ResizeImages(
                ...
                .Append(context.Transforms.ApplyOnnxModel(
                    modelFile: "./ObjectDetection/MLBasedObjectDetectionStrategy/ONNXModel/model.onnx",
            ...
            _labels = File.ReadAllLines("./ObjectDetection/MLBasedObjectDetectionStrategy/ONNXModel/labels.txt");
        ...
        public Rectangle DetectObject(Mat frame)
        {
            ...
            var boundingBoxes = ParseOutputs(prediction.ObjectType, _labels);
        ...
        // Helper methods
        // ----------
        private static List<BoundingBox> ParseOutputs(float[] modelOutput, string[] labels, float probabilityThreshold = .1f)
        {
