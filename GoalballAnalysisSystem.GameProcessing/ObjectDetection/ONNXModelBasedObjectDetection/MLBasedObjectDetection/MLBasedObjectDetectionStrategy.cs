...
namespace GoalballAnalysisSystem.GameProcessing.ObjectDetection.ONNXModelBasedObjectDetection.MLBasedObjectDetection
{
    public class MLBasedObjectDetectionStrategy : IObjectDetectionStrategy
    {
        ...
        public MLBasedObjectDetectionStrategy(List<string> targetLabels, float probabilityThreshold = 0.1f)
        {
            ...
            var pipeline = context.Transforms.ResizeImages(
                ...
                .Append(context.Transforms.ApplyOnnxModel(
                    modelFile: "./ObjectDetection/ONNXModelBasedObjectDetection/ONNXModel/model.onnx",
            ...
            _labels = File.ReadAllLines("./ObjectDetection/ONNXModelBasedObjectDetection/ONNXModel/labels.txt");
