...
namespace GoalballAnalysisSystem.GameProcessing.PlayFieldTracker
{
    public static class FilterParameters
    {
        ...
        public static readonly Pair<int, int> Saturation = new Pair<int, int>(13, 130);
        ...
        /*public static readonly Pair<int, int> Hue = new Pair<int, int>(2, 12);
        public static readonly Pair<int, int> Saturation = new Pair<int, int>(0, 255);
        public static readonly Pair<int, int> Value = new Pair<int, int>(0, 255);*/

        public static readonly int StructElementSizeErode = 4;
        public static readonly int StructElementSizeDilate = 4;
